...
if (!class_exists('SHGdprdm_ShortCodes')) {
    class SHGdprdm_ShortCodes
    {
        ...
        // Add Shortcode
        public function shgdprdm_k9x9adew87_shortcode($atts = [], $content = null, $tag = '')
        {
            // Commented out code is example of a shortcode using all passed params
            ...
            //   // title
            //   $o .= '<h2>' . esc_html__($wporg_atts['title'], 'shgdprdm_test') . '</h2>';
            ...
            $sections = array(
                ...
                'shgdprdm_tandc_options' => array(
                    'Heading' => array(
                        'item' => 'tandc_header_option',
                        'default' => 'SHGDPRDM_DEFAULT_TERMS_HEADER_CONDITIONS_TEXT'
                    ),
                    'text' => array(
                        'item' => 'tandc_option',
                        'default' => 'SHGDPRDM_DEFAULT_TERMS_CONDITIONS_TEXT'
                    )
                ),
        ...
        {
            add_shortcode('gdm-privacy-policy-custom-pro', array($this, 'shgdprdm_k9x9adew87_shortcode'));
        }
